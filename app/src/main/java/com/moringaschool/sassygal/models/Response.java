...
public class Response implements Serializable {
     ...
     * @param updatedAt
     */
    public Response(Integer id, String brand, String name, String price, Object priceSign, Object currency, String imageLink, String productLink, String websiteLink, String description, Double rating, Object category, String productType, List<String> tagList, String createdAt, String updatedAt, String productApiUrl, String apiFeaturedImage, List<com.moringaschool.sassygal.models.ProductColor> productColors) {
        super();
        this.id = id;
        this.brand = brand;
        this.name = name;
    ...
    public List<com.moringaschool.sassygal.models.ProductColor> getProductColors() {
